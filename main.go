...
import (
	...
	"github.com/roumpid/rabbitmq-goperf/tests"
)
...
func main() {
	...
	tc := flag.Int("threads", 60, "Thread Count")
	rut := flag.Int("rampup", 60, "Ramp up time in seconds")
	et := flag.Int("etime", 300, "Execution time in seconds")
	flag.Parse()
